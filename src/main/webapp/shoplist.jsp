	...
	<div id="content">
        <section id="vMenu">
            ...
            <div>
                ...
                <ul>
                    <li><a class="sub" href="/mpro/shop/list.do?code=topss">반팔</a></li>
		                ...
		                <c:forEach var="k" begin="1" end="3" step="1">
		                	...
		                	<c:if test="${ not doLoop }">
			                    <a class="product" href="/mpro/shop/detail.do?code=${ product[(i - 1) * 3 + k - 1].code }">
			                        <div class="imageD" style="background-image: url('/mpro/asset/img/${ upper[(i - 1) * 3 + k - 1] }/${ product[(i - 1) * 3 + k - 1].representative }')"></div>
